...
const getCurrentEventFor = (req, res /* , next */) => getEvents(res, req.body.queryResult.parameters.square);
      ...
      events.forEach((event) => {
        ...
        const card = new Card(
          ...
          `${event.name.value} (${moment
            ...
            .format('HH:mm')} - ${moment.parseZone(event.endDate.value).format('HH:mm')})`,
          {
